<?php
    ...
    $_SESSION['currentpage'] = "PowerSupplies";
    
    // get delay items from effects table in db
    $productQuery = "SELECT * FROM PedalDistrict.products WHERE subcategory = 'PowerSupplies';";
                        ...
                        for ($p = 0; $p < $numCols && $p < 3; $p++) {
                            ...
                            echo "<div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>";
                                ...
                                echo "<div class='centerBlock'>";
                                    echo "<img src='" . "images/" . $productsArray[$temp]['coverImage'] . "' class='home-product-image img-responsive' id='new-product-image'>";
                                echo "</div>";
